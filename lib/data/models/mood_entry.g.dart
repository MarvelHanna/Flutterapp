...
MoodEntry _moodEntryDeserialize(
  ...
  final object = MoodEntry(
    ...
    id: id,
    mood: reader.readLong(offsets[2]),
...
extension MoodEntryQueryFilter
  ...
  QueryBuilder<MoodEntry, MoodEntry, QAfterFilterCondition> energyEqualTo(
      int value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'energy',
  ...
  QueryBuilder<MoodEntry, MoodEntry, QAfterFilterCondition> energyGreaterThan(
    int value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<MoodEntry, MoodEntry, QAfterFilterCondition> energyLessThan(
    int value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<MoodEntry, MoodEntry, QAfterFilterCondition> energyBetween(
    int lower,
    int upper, {
    bool includeLower = true,
    bool includeUpper = true,
...
extension MoodEntryQuerySortBy on QueryBuilder<MoodEntry, MoodEntry, QSortBy> {
  ...
  QueryBuilder<MoodEntry, MoodEntry, QAfterSortBy> sortByEnergy() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'energy', Sort.asc);
    });
  }

  QueryBuilder<MoodEntry, MoodEntry, QAfterSortBy> sortByEnergyDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension MoodEntryQuerySortThenBy
  ...
  QueryBuilder<MoodEntry, MoodEntry, QAfterSortBy> thenByEnergy() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'energy', Sort.asc);
    });
  }

  QueryBuilder<MoodEntry, MoodEntry, QAfterSortBy> thenByEnergyDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'energy', Sort.desc);
    });
  }
...
extension MoodEntryQueryWhereDistinct
  ...
  QueryBuilder<MoodEntry, MoodEntry, QDistinct> distinctByEnergy() {
    return QueryBuilder.apply(this, (query) {
...
extension MoodEntryQueryProperty
  ...
  QueryBuilder<MoodEntry, int, QQueryOperations> energyProperty() {
    return QueryBuilder.apply(this, (query) {
