...
const CalendarEventSchema = CollectionSchema(
  ...
  properties: {
    r'area': PropertySchema(
      ...
      enumMap: _CalendarEventareaEnumValueMap,
    ),
    ...
    r'travelBufferMinutes': PropertySchema(
      id: 8,
      name: r'travelBufferMinutes',
      type: IsarType.long,
    )
  },
...
void _calendarEventSerialize(
  ...
  writer.writeBool(offsets[2], object.isAllDay);
  ...
  writer.writeDateTime(offsets[6], object.start);
  writer.writeString(offsets[7], object.title);
  writer.writeLong(offsets[8], object.travelBufferMinutes);
}
...
CalendarEvent _calendarEventDeserialize(
  ...
  final object = CalendarEvent(
    area: _CalendarEventareaValueEnumMap[reader.readStringOrNull(offsets[0])] ??
        LifeArea.work,
    end: reader.readDateTime(offsets[1]),
    id: id,
    isAllDay: reader.readBoolOrNull(offsets[2]) ?? false,
    ...
    start: reader.readDateTime(offsets[6]),
    title: reader.readString(offsets[7]),
    travelBufferMinutes: reader.readLongOrNull(offsets[8]) ?? 0,
  );
  return object;
}
...
P _calendarEventDeserializeProp<P>(
  ...
  switch (propertyId) {
    case 0:
      return (_CalendarEventareaValueEnumMap[reader.readStringOrNull(offset)] ??
          LifeArea.work) as P;
    case 1:
...
const _CalendarEventareaEnumValueMap = {
  r'school': r'school',
  r'work': r'work',
  r'home': r'home',
  r'health': r'health',
...
const _CalendarEventareaValueEnumMap = {
...
extension CalendarEventQueryFilter
  ...
  QueryBuilder<CalendarEvent, CalendarEvent, QAfterFilterCondition> areaEqualTo(
    LifeArea value, {
  ...
  QueryBuilder<CalendarEvent, CalendarEvent, QAfterFilterCondition> areaBetween(
    LifeArea lower,
    LifeArea upper, {
    bool includeLower = true,
    bool includeUpper = true,
  ...
  QueryBuilder<CalendarEvent, CalendarEvent, QAfterFilterCondition> areaMatches(
      String pattern,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<CalendarEvent, CalendarEvent, QAfterFilterCondition>
      travelBufferMinutesEqualTo(int value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'travelBufferMinutes',
        value: value,
      ));
    });
  }
  ...
  QueryBuilder<CalendarEvent, CalendarEvent, QAfterFilterCondition>
      travelBufferMinutesGreaterThan(
    int value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
...
extension CalendarEventQueryObject
    on QueryBuilder<CalendarEvent, CalendarEvent, QFilterCondition> {
  QueryBuilder<CalendarEvent, CalendarEvent, QAfterFilterCondition> reminder(
...
extension CalendarEventQuerySortBy
  ...
  QueryBuilder<CalendarEvent, CalendarEvent, QAfterSortBy> sortByArea() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'area', Sort.asc);
    });
  }

  QueryBuilder<CalendarEvent, CalendarEvent, QAfterSortBy> sortByAreaDesc() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<CalendarEvent, CalendarEvent, QAfterSortBy> sortByNotes() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'notes', Sort.asc);
    });
  }

  QueryBuilder<CalendarEvent, CalendarEvent, QAfterSortBy> sortByNotesDesc() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<CalendarEvent, CalendarEvent, QAfterSortBy>
      sortByTravelBufferMinutes() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'travelBufferMinutes', Sort.asc);
    });
  }

  QueryBuilder<CalendarEvent, CalendarEvent, QAfterSortBy>
      sortByTravelBufferMinutesDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'travelBufferMinutes', Sort.desc);
    });
  }
}
...
extension CalendarEventQuerySortThenBy
  ...
  QueryBuilder<CalendarEvent, CalendarEvent, QAfterSortBy> thenByArea() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'area', Sort.asc);
    });
  }

  QueryBuilder<CalendarEvent, CalendarEvent, QAfterSortBy> thenByAreaDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'area', Sort.desc);
    });
  }
  ...
  QueryBuilder<CalendarEvent, CalendarEvent, QAfterSortBy> thenByNotes() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'notes', Sort.asc);
    });
  }

  QueryBuilder<CalendarEvent, CalendarEvent, QAfterSortBy> thenByNotesDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'notes', Sort.desc);
    });
  }
...
extension CalendarEventQueryWhereDistinct
  ...
  QueryBuilder<CalendarEvent, CalendarEvent, QDistinct> distinctByArea(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<CalendarEvent, CalendarEvent, QDistinct> distinctByNotes(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<CalendarEvent, CalendarEvent, QDistinct>
      distinctByTravelBufferMinutes() {
    return QueryBuilder.apply(this, (query) {
      return query.addDistinctBy(r'travelBufferMinutes');
    });
  }
}
...
extension CalendarEventQueryProperty
  ...
  QueryBuilder<CalendarEvent, LifeArea, QQueryOperations> areaProperty() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<CalendarEvent, String?, QQueryOperations> notesProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'notes');
    });
  }

  QueryBuilder<CalendarEvent, Reminder?, QQueryOperations> reminderProperty() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<CalendarEvent, int, QQueryOperations>
      travelBufferMinutesProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'travelBufferMinutes');
    });
  }
}
